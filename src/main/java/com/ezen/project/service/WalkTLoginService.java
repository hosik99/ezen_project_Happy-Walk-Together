...
public class WalkTLoginService {
	...
	public boolean sendMineMessage(String del_email, String family_pwd, int rd)
	   {
	      MimeMessage mimeMessage = sender.createMimeMessage();
	      String content ="<h3>"+rd+"</h3>"
	        		+ "<form method='post' action='http://localhost:58172/pet_login/form_complate/"+del_email+"/"+family_pwd+"/"+rd+"'>"
	      ...
	      try {
	         ...
	         addressTo[0] = new InternetAddress(del_email);
