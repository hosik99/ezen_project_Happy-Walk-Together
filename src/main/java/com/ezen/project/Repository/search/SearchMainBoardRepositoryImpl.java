...
public class SearchMainBoardRepositoryImpl extends QuerydslRepositorySupport implements SearchMainBoardRepository {
	...
	public Page<Object[]> searchPage(String type, String keyword, Pageable pageable) {
		...
		jpqlQuery.leftJoin(mainBoard.mainBoardAuthor);
		jpqlQuery.leftJoin(mainBoardReply).on(mainBoardReply.mainboard.eq(mainBoard));
		
		JPQLQuery<Tuple> tuple = jpqlQuery.select(mainBoard.mainBoardNum, mainBoard.mainBoardTitle.min(), mainBoard.mainBoardAuthor.memberEmail.min(), mainBoardReply.count());
